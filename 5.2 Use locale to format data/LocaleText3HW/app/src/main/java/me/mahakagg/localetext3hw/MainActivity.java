package me.mahakagg.localetext3hw;
...
*
* Q1 - Which of the following statements returns a general-purpose number format for the user-selected language and locale?
* A1 - NumberFormat numberFormat = NumberFormat.getInstance();
*
* Q2 - Which of the following statements converts a locale-formatted input quantity string to a number?
* A2 - myInputQuantity = numberFormat.parse(v.getText().toString()).intValue();
*
* Q3 - Which of the following statements retrieves the country code for the user-chosen locale?
* A3 - String deviceLocale = Locale.getDefault().getCountry();
* */
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextView totalTextView = findViewById(R.id.total);
        ...
        enteredQuantity.setOnEditorActionListener(new EditText.OnEditorActionListener() {
            ...
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                if (actionId == EditorInfo.IME_ACTION_DONE) {
                    ...
                    //Homework: Calculate the total amount
                    // from price and quantity.
                    double totalAmount = mInputQuantity * mPrice;

                    // Homework: Use currency format for
                    // France (FR) or Israel (IL).
                    String formattedTotal = mCurrencyFormat.format(totalAmount);

                    // Homework: Show the total amount string.
